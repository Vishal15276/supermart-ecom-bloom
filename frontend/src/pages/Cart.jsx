              ...
              {cart.map((item) => (
                <div key={item.id} className="p-4 grid grid-cols-1 md:grid-cols-6 gap-4 items-center">
                  ...
                  <div className="md:text-center">
                    ...
                    <button 
                      onClick={() => removeFromCart(item.id)}
                      className="text-red-500 hidden md:block md:mt-2"
                    >
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <div className="mb-6">
                ...
                <div className="text-xs text-gray-500 mt-2">
                  <p>Try these demo codes:</p>
                  <div className="flex items-center mt-1">
                    <span className="bg-gray-100 px-2 py-1 rounded mr-2">DISCOUNT10</span>
                    <span>10% off your order</span>
                  </div>
                  <div className="flex items-center mt-1">
                    <span className="bg-gray-100 px-2 py-1 rounded mr-2">FREESHIP</span>
