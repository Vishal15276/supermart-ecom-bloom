...
import { CheckCircle, ShoppingBag, ChevronRight, Printer, Calendar, Truck, MapPin } from "lucide-react";
    ...
    <div className="container mx-auto px-4 py-10">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-between gap-4">
          ...
          <Button asChild className="flex-1 bg-supermart-primary hover:bg-supermart-dark">
